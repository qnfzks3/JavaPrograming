...
import qnfzks3.project.sungjuk.service.SungJukV4ServiceImpl;

public class SungjukV4Main {
    public static void main(String[] args) {

        //성적 처리프로그램 v4   --스프링 까지 들어가면 이 성적 처리 프로그램은 5개의 파일을 만들어질 것
        //배열과 클래스,인터페이스 , 예외처리 , 컬렉션 , JDBC를 이용해서 성적을 입력하면 총점, 평균 , 학점을 계산함
        ...
        SungJukV2Service sjsrv = new SungJukV4ServiceImpl();
